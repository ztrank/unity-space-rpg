namespace SpaceRpg.Gameplay.UI
{
    ...
    public class UnityServicesUIHandler : MonoBehaviour
    {
        ...
        {
            this.m_ServiceErrorSubscription = serviceError;
            this.m_ServiceErrorSubscription.Subscribe(this.ServiceErrorHandler);
        }
        ...
        void OnDestroy()
        {
            this.m_ServiceErrorSubscription?.Unsubscribe(ServiceErrorHandler);
        }
    }
}